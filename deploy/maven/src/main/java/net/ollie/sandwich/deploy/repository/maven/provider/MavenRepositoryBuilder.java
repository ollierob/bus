...
import net.ollie.sandwich.deploy.repository.maven.central.MavenCentralRepository;
import net.ollie.sandwich.deploy.repository.maven.central.MavenCentralSearchResource;
import net.ollie.sandwich.deploy.repository.maven.nexus3.Nexus3Repository;
import net.ollie.sandwich.deploy.repository.maven.nexus3.Nexus3RepositoryResource;
