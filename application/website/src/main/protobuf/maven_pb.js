 ...
 * @constructor
 */
proto.maven.MavenRepositoryList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.maven.MavenRepositoryList.repeatedFields_, null);
};
goog.inherits(proto.maven.MavenRepositoryList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.maven.MavenRepositoryList.displayName = 'proto.maven.MavenRepositoryList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.maven.MavenRepositoryList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.maven.MavenRepositoryList.prototype.toObject = function(opt_includeInstance) {
  return proto.maven.MavenRepositoryList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.maven.MavenRepositoryList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.maven.MavenRepositoryList.toObject = function(includeInstance, msg) {
  var f, obj = {
    repositoryList: jspb.Message.toObjectList(msg.getRepositoryList(),
    proto.maven.MavenRepository.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.maven.MavenRepositoryList}
 */
proto.maven.MavenRepositoryList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.maven.MavenRepositoryList;
  return proto.maven.MavenRepositoryList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.maven.MavenRepositoryList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.maven.MavenRepositoryList}
 */
proto.maven.MavenRepositoryList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.maven.MavenRepositoryList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.maven.MavenRepositoryList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.maven.MavenRepositoryList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.maven.MavenRepositoryList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.maven.MavenRepository>}
 */
proto.maven.MavenRepositoryList.prototype.getRepositoryList = function() {
  return /** @type{!Array<!proto.maven.MavenRepository>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.maven.MavenRepository, 1));
};
...
/**
 * @param {!proto.maven.MavenRepository=} opt_value
 * @param {number=} opt_index
 * @return {!proto.maven.MavenRepository}
 */
proto.maven.MavenRepositoryList.prototype.addRepository = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.maven.MavenRepository, opt_index);
};
